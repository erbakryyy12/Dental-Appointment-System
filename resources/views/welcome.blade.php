...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-white dark:text-black/50">
        <div class="bg-gray-50 text-black/50 dark:bg-white dark:text-black/50">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="/img/dental logo.png" />
                                ...
                                @else
                                    <div class="relative">
                                        ...
                                        <div id="loginDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden">
                                            ...
                                            <a href="{{ route('dentistLogin') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dentist</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="flex-container">    
                                            <div class="text-content">
                                                ...
                                                Welcome to our Dental Appointment System, where scheduling your dental appointments is now simpler than ever. Our user-friendly online platform allows you to conveniently book your dental appointments from anywhere, whether you're at home or on the go. With just a few clicks, you can access our system and browse through available time slots to find the perfect appointment time that fits seamlessly into your schedule. Say goodbye to the hassle of phone calls or in-person visits – our system streamlines the entire process, saving you time and effort. Experience the convenience of modern dental care with our easy-to-use online booking feature.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
